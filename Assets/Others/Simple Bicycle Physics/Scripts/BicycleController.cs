...
namespace SBPScripts
{
    ...
    public class BicycleController : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            //CycleOscillation
            if ((currentSpeed > 5 && isReversing == false) || isAirborne || isBunnyHopping)// sprint removed
        ...
        void Update()
        {
            ...
            //Debug.Log("value  "  +torque * customAccelerationAxis);

            rb.velocity = this.transform.forward * speed /3.6f;

            customAccelerationAxis = 0.5f;
            rawCustomAccelerationAxis = 0.5f;
